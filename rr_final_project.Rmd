...
__Step 10:__ The data are plotted in a time-series line graph faceted over event category. A log-scale is applied to the y-value, otherwise outlying peak values in some of the categories, specifically `HURRICANE` and `FLOOD`, exaggerate the range of the y-scale.  
...
__Step 12:__ The location of instances of the most frequent categories are geographically plotted. Because of the sheer number of events in each category and to make the plot readable, only the top 95% quantile is plotted.
...
plot(log(noaa_clean[-604411,]$PROPDMG_TOT+noaa_clean[-604411,]$CROPDMG_TOT), col=noaa_clean[-604411,]$EVCAT)
