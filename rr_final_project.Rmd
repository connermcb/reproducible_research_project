...
__Step 8:__ As a preliminary formatting step for examining material damage, an integer estimate of the damages caused by each event is calculated using the base and exponent variable. Observations with anomalous values (e.g. `PROGDMGEXP`="?")  are removed from the dataset.
