...
```{r Get Packages, message=FALSE, warning=FALSE, echo=FALSE}
# load packages
library(dplyr)
library(ggplot2)
library(gtable)
...
```{r Load Data, cache=TRUE, message=FALSE, warning=FALSE, echo=FALSE}
...
noaa_clean <- noaa[!(stri_detect_regex(noaa$EVTYPE, "SUMMARY", noaa$EVTYPE)),]
