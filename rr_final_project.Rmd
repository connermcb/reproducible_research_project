...
The U.S. National Oceanic and Atmospheric Administration's (NOAA) Severe Weather dataset tracks extreme weather events in the United States and includes estimates of casualties and property damage. The report will focus on these features of the dataset by compiling similar events types for the purpose of ranking the resulting categories by consequential human casualties and material damage. 

The data themselves required extensive cleaning and reformatting. As mentioned and mos notably, the wide-ranging weather event types were gathered into general categories based on similar characteristics such as temperature, percipitation type, storm variety or variations in event naming. The result were more interpretable data that I think supported more meaningful and interpretable descriptions of the data.
